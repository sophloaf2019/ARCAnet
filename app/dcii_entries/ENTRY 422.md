...
# DCII ENTRY 422
## SUBJECT 1
**Classification**: Item (Enchanted, <3>Haunted</3> Vehicle)
...
It should also be noted that Robert included a note saying the RV was <3>haunted</3>. It's presumed this is the reason it was sold in the first place. Robert notes some frustrations with <3>the ghost, saying it rots food if you're not looking and clangs on pipes in the engine</3>.
### Alan Baker
...
### Donna Tanner
Donna bought the RV from Alan on 2008-09-03. She, like Robert, was a magic user. She noted that she added some artifacts from her personal collection, namely the <2>"map of the sea"</2> and the <2>"compass of desire"</2>. She was not great at filling the log, only noting she was on "adventures" for great swaths of time. She unfortunately passed before the investigation as well, making it difficult to ascertain the truth of what she used it for. 

After she passed, it was sold in an estate sale. 

### The Mystic
An unnamed sorcerer bought it from the estate sale on 2012-12-20. They filled out the log with meticulous detail, but refused to identify themselves, only writing in as The Mystic. They added a <2>"mask of seer"</2> and <2>"seer stone"</2>, the <2>mask</2> on the back of the RV and the <2>stone</2> by the steering wheel. touching the <2>stone</2> enables you to see through the <2>mask's eyes</2>, causing it to function as backup camera. 

The Mystic also added a <2>"glossover"</2> diffuser system of copper piping, retrofitted the engine with an <2>alchemical quicksilver rune block</2>, started a small collection of magic herbs, and installed a foldable alchemical brewery kit.

The Mystic has also journaled that they have <3>successfully befriended the ghost. By leaving out food and snacks, the ghost will "consume" the food by rapidly rotting or spoiling it. The identify of the ghost is entirely unknown, but The Mystic refers to it as the "girl in the walls". Apparently, the ghost is also capable of manipulating the steering wheel and gas pedal, allowing The Mystic to take a break from driving.</3>

<3>The Mystic makes it abundantly clear that they are not enslaving the ghost. They provide ample entertainment, conversation, and food, and respect no's and try not to push. The Mystic claims that Alan was particularly rude to the ghost, since the ghost cannot actually depart from the RV, but that their relationship has been healthy so far. The girl ghost apparently enjoys energy drinks, sour candies, and spicy chips. The food items are just discarded after the ghost is done with it.</3>
...
## SUBJECT 2, 3, 4, 5, 6, 7
**Classification**: <2>Item (Enchanted Tool)</2>

**Containment Status**: <2>Missing</2>

**Danger/Probability**: <2>3/1</2>

**Restriction**: 2

**Description**: <2>Subjects 2-7 are the various items within the RV that deserve their own subject designations, but share a **Restriction** level and **Classification**.</2>

### SUBJECT 2
<2>Subject 2 is the "map of the sea". It displays the RV as a galleon, roads and parking lots as water, and destinations (like neighborhoods and large stores) show as islands with dramatized names (like the Club of Admiral Sam, for Sam's Club). The map is blank when opened and inks itself magically to show the immediate area. When it is closed, it erases itself. If the map is opened and then left alone, it may start to doodle sea monsters or other events on the world map. 
...
This item is definitely magical. People with zero magical aptitude cannot activate the map.</2>
### SUBJECT 3
<2>Subject 3 is the "compass of desire". It is brass, with a red and white needle and glass protective cover. Inside are two rows and ten columns of flip display characters, engraved in a hand-done but very fancy script. 
...
This is a magic item as well.</2>
### SUBJECT 6
<2>Subject 6 is the cash register. Much like the RV, it is of unknown make or model, featuring only small old-school buttons for $1, $5, $10, $20, $50, and $100. A faded label reads "BALANCE", and reports how much the register holds, maxing out at $100, using a flip-style display.
...
After roughly half an hour, the bill will dissipate as soon as it is no longer observed. Placing a bill under constant observation will extend this life span perhaps indefinitely. However, even a blink is enough time for it to vanish.</2>
### SUBJECT 7
<2>Subject 7 is the rune block in the engine bay. By pouring alchemical quicksilver over the runes, they activate, producing rotational power on a flywheel and generating torque. The alternator is still present and charges the battery, which only powers the electronics. A diagram of this machine is available upon request.</2>

## SUBJECT 8
**Classification**: <3>Entity (Ghost)</3>

**Containment Status**: <3>Missing</3>

**Danger/Probability**: <3>6/1</3>

**Restriction**: 3

**Description**: <3>Subjects 8 is the ghost that resides in the RV. The spirit belongs to (presumably) a young woman of about 20 years of age, from before the first owner's purchase. The ghost is best described as "catty", often causing frustrations for researchers and operators alike.
